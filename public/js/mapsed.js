...
(function () {
	...
	$.fn.mapsed = function (options) {
		...
		/// <summary>
		/// Displays a  message over the top of the map
		...
		/// <summary>
		/// Displays a  confirmation over the top of the map, prompting
		...
		/// <summary>
		/// Helper for building up a  message on the screen.
		...
		function buildMsg(title, msg, doConfirm, prompt, callback) {
			...
			buttons += "<div class='mapsed--button-bar'>";
			if (prompt && prompt.length > 0) {
				buttons += "<p class='prompt'>" + prompt + "</p>";
			}
			buttons += "<div class='mapsed--buttons'>";
			if (doConfirm) {
